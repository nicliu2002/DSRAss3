...
class Node implements NodeInteface, Comparable<Node> {
    ...
    public int compareTo(Node other) {
        ...
        Duration thisD = Duration.between(today.atStartOfDay(), thisNextBDay.atStartOfDay());
        ...
        Duration otherD = Duration.between(today.atStartOfDay(), otherNextBDay.atStartOfDay());
        return thisD.compareTo(otherD); //if you test it, and it goes from furthest away to closest just delete -1
    }
